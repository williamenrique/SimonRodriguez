<?= head($data)?>
    ...
    <div class="slider-area">
        <div class="page-title">
            <div class="single-slider slider-height slider-height-breadcrumb d-flex align-items-center" style="background-image: url(<?= IMG ?>bg/bg.jpg);">
                <div class="container">
                    <div class="row">
                        <div class="col-xl-12">
                ...
                <div class="col-xl-7 col-lg-7">
                    <div class="about-title-section about-title-section-2 mb-30">
                        ...
                        <p class="text-justify">
                            ...
                            Además de su labor política, Simón Rodríguez también se destacó como pedagogo, promoviendo una educación liberadora que fomentara el pensamiento crítico y la autonomía intelectual. Fundó varias escuelas en Venezuela y Colombia, donde implementó métodos innovadores para enseñar a los niños y jóvenes.
                ...
                <div class="col-xl-5 col-lg-5">
                    <div class="about-title-section about-title-section-2 mb-30">
                        ...
                        <p class="text-justify">
                            ...
                            A lo largo de su historia, la universidad ha sido un espacio de resistencia y lucha contra las injusticias sociales y políticas en Venezuela. Ha promovido la inclusión de sectores marginados en la educación superior, así como la investigación interdisciplinaria y la formación integral de sus estudiantes.

                            En la actualidad, la Universidad Simón Rodríguez continúa siendo una institución relevante en el panorama académico venezolano, destacándose por su compromiso con la formación de profesionales críticos y comprometidos con el desarrollo sostenible y equitativo del país.
                        </p>
                    </div>
                </div>
            </div>
            ...
            <div class="row">
                <div class="col-xl-7 col-lg-7">
                    <div class="about-title-section about-title-section-2 mb-30">
                        ...
                        <p class="text-justify">
                            El núcleo de la Universidad Simón Rodríguez en Lara fue creado en el año 2001, como parte de un proyecto de descentralización universitaria en Venezuela. La idea surgió como respuesta a la necesidad de ofrecer educación superior a los habitantes del estado Lara, que hasta entonces tenían que trasladarse a otras ciudades para poder estudiar.

                            El núcleo de la Universidad Simón Rodríguez en Lara comenzó sus actividades con una oferta académica limitada, centrada principalmente en carreras relacionadas con las ciencias sociales y humanidades. Con el paso de los años, la institución fue ampliando su oferta educativa, incorporando nuevas carreras y programas de estudio.

                            Hoy en día, el núcleo de la Universidad Simón Rodríguez en Lara se ha consolidado como una institución de prestigio en la región, ofreciendo una formación académica de calidad y contribuyendo al desarrollo social y cultural del estado. Además, ha establecido convenios con otras instituciones educativas y organismos gubernamentales para fortalecer su labor académica y promover la investigación científica.

                            En resumen, la creación del núcleo de la Universidad Simón Rodríguez en Lara ha sido un importante paso en la democratización del acceso a la educación superior en Venezuela, brindando oportunidades de formación a miles de estudiantes larenses y contribuyendo al desarrollo integral de la región.
