...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 05-05-2024 a las 19:32:06
...
CREATE TABLE `table_autoridades` (
  ...
  `nombre_autoridad` varchar(60) COLLATE utf8_spanish_ci NOT NULL,
  `cargo_autoridad` varchar(60) COLLATE utf8_spanish_ci NOT NULL,
  `img_autoridad` varchar(60) COLLATE utf8_spanish_ci NOT NULL,
...
CREATE TABLE `table_documentos` (
  ...
  `nombre_documento` varchar(60) COLLATE utf8_spanish_ci NOT NULL,
  `ruta_documento` varchar(60) COLLATE utf8_spanish_ci NOT NULL,
...
(1, 1, 'PENSUM LCD ADMIN', 'ADMINISTRACION MENCION ADMINISTRACION RECURSOS HUMANOS.pdf', 'pensum', 1),
...
CREATE TABLE `table_equipo` (
  ...
  `nombre_equipo` varchar(20) COLLATE utf8_spanish_ci NOT NULL,
  `cargo_equipo` varchar(60) COLLATE utf8_spanish_ci NOT NULL,
  `img_equipo` varchar(100) COLLATE utf8_spanish_ci NOT NULL,
...
CREATE TABLE `table_evento` (
  ...
  `cuerpo_evento` text COLLATE utf8_spanish_ci NOT NULL,
  `fecha_evento` date NOT NULL,
  `hora_evento` varchar(20) COLLATE utf8_spanish_ci NOT NULL,
  `ponente_evento` text COLLATE utf8_spanish_ci NOT NULL,
  `img_evento` varchar(60) COLLATE utf8_spanish_ci NOT NULL,
...
CREATE TABLE `table_instituto` (
  `id_instituto` int(5) NOT NULL,
  `nombre_instituto` varchar(50) COLLATE utf8_spanish_ci NOT NULL,
  `tlf_instituto` varchar(50) COLLATE utf8_spanish_ci NOT NULL,
  `email_instituto` varchar(50) COLLATE utf8_spanish_ci NOT NULL,
  `direccion_instituto` text COLLATE utf8_spanish_ci NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_spanish_ci;
...
CREATE TABLE `table_pensamiento` (
  ...
  `id_instituto` int(1) NOT NULL,
  `pensamiento` text COLLATE utf8_spanish_ci NOT NULL,
  `pagina_instituto` varchar(20) COLLATE utf8_spanish_ci NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_spanish_ci;
...
CREATE TABLE `table_preguntas` (
  ...
  `pregunta_instituto` text COLLATE utf8_spanish_ci NOT NULL,
  `respuesta_instituto` text COLLATE utf8_spanish_ci NOT NULL,
  `id_instituto` int(1) NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_spanish_ci;
...
CREATE TABLE `table_testimonio` (
  ...
  `persona_testimonio` varchar(20) COLLATE utf8_spanish_ci NOT NULL,
  `testimonio` text COLLATE utf8_spanish_ci NOT NULL,
  `puesto_persona_testimonio` varchar(20) COLLATE utf8_spanish_ci NOT NULL,
  `img_persona` varchar(60) COLLATE utf8_spanish_ci NOT NULL,
