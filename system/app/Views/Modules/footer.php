        						...
        						<div class="footer-widget mb-30">
        							...
        							<div class="footer-para">
        								<ul class="text-white" style="font-size: 14px">
        									<li style="list-style: auto;">
        										Tiene como visión ser una Institución global de vocación, integracionista y latinoamericana,
        										abierta a los cambios. Flexible innovadora, andragogica y de excelencia, que
        									...
        									<li style="list-style: auto;">
        										Tiene como misión fundamental la búsqueda, generación, aplicación y difusión del
        										conocimiento y al afianzamiento de los valores transcendentales del hombre y la sociedad
        									</li>
        									<li style="list-style: auto;">
        										Contribuir con el desarrollo económico y social de la región Sur del Lago y fomentar la
        										defensa, protección y recuperación del medio ambiente, mediante actividades especiales de
        										conservación ecológica. Auspiciar y realizar estudios sobre la realidad de la frontera y
        										promover la integración binacional.
        									</li>
        								</ul>
        							</div>
        							<div class="footer-socila-icon">
        								...
        								<div class="footer-social-icon-list">
        									<ul>
        										<li><a href="<?= $data['face_instituto']?>" target="_blank"><span
        													class="ti-facebook"></span></a></li>
        										<li><a href="<?= $data['insta_instituto']?>" target="_blank"><span
